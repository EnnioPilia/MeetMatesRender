...
/**
 * Service pour gérer les cookies d'authentification et de refresh token. Permet
 * de créer, supprimer et configurer les cookies sécurisés pour l'utilisateur.
 */
@Service
...
private String domain;
    ...
    /**
     * Supprime les cookies d'authentification et de refresh en les remplaçant
